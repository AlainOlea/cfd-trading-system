# CFD Trading System - 1min Scalping Paper Trade
# Runs: Every 30 min (:00 and :30) 07:00-15:59 ET Mon-Fri via Windows Task Scheduler
# Orders: DAY (intraday), SL/TP per strategy (scalping-tight)
...
echo '========================================'
echo '1min signals: '`$(date -u '+%Y-%m-%d %H:%M UTC')
echo '========================================'
python3 main.py paper-trade --interval 1m --no-news --min-confluence 3 --min-confidence 60 2>&1 | tee -a $LogDir/oneminute_${Date}.log
"@
